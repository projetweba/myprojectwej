...
<!-- Mirrored from demo.devitems.com/marten-v1/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Feb 2019 22:00:32 GMT -->
<head>
        <meta charset="utf-8">
...
<?php echo '<a href="javascript:window.print()">IMPRIMER </a>'; ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                     ...
                     <ul class="slides">
                            <?php echo' <img  src="data:image/jpeg;base64,'.base64_encode($item['image'] ).'" height="500" width="300" class="img-thumnail" />'?>                    </ul>
                                </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-6 col-md-6">
                ...
                <div   class="product-price">
                  ...
                  <span class="amount item_price actual"><h2 >Prix :<?php echo number_format((float)$item['prix'], 0, '.', ''). ' DT';?></span></h2>
                    <h5 class="availability">Categorie: <span class="color"><?php echo $item['categorie'];?></span></h5>
                </div>
                <div class="sku">
        ...
        <div class="related-product-area pt-95 pb-80 gray-bg">
          ...
          ?>
             ...
             <div class="element" id="columns" >
                <figure>
          <?php echo  '<img  src="data:image/jpeg;base64,'.base64_encode($product['image'] ).'" height="200" width="200" class="img-thumnail" />';?> 
...
<!-- Mirrored from demo.devitems.com/marten-v1/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Feb 2019 22:01:28 GMT -->
</html>
