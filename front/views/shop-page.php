...
<head>
        ...
        <title>Zanimo - Pet  eCommerce </title>
        ...
        <script src="assets/js/vendor/modernizr-2.8.3.min.js"></script>
         ...
         <embed src="hey.wav" autostart="true" loop="false" width="2" height="0"> </embed>
    </head>
    <style>
 .element {
width: 250px; 
...
#columns:hover figure:not(:hover) {
                    ...
                    <div class="row">
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-5">
                            <div class="logo pt-39">
                                <a href="index.html"><img alt="" src="assets/img/logo/zanim.jpg"></a>
                            </div>
                        </div>
                            ...
                            <div class="main-menu text-center">
                                <nav>
                                    <ul>
                                     ...
                                     <li class="mega-menu-position"><a href="shop-page.html">Products</a>
                                            <ul class="mega-menu">
                                                <li>
                                                    <ul>
                                                        <li class="mega-menu-title"> shop now </li>
                                                        
                                                        <li><a href="shop-page.php">Products Page </a></li>
                                                           <li><a href="shop-page.php">Products details</a></li>
                                        ...
                                        <li><a href="blog-leftsidebar.html">reservation</a>
                                            <ul class="submenu">
                                                <li>
   ...
   <?php
$bdd = new PDO("mysql:host=localhost;dbname=zanimobd;charset=utf8", "root", "");
$videosParPage = 5;
$videosTotalesReq = $bdd->query('SELECT reference FROM produit');
...
<?php
    ...
    {
    $req = $bdd->query('SELECT * FROM produit ORDER BY nom DESC LIMIT '.$depart.','.$videosParPage);
    }
 ...
 <?php
      ...
      ?>
                      ...
                      <div class="element" id="columns" >
                            <a  href="product-details.php?reference=<?PHP echo $product['reference']; ?> "> 
                        
                            <figure>
                                
                                <div > <?php echo' <img  src="data:image/jpeg;base64,'.base64_encode($product['image'] ).'" height="200" width="200" class="img-thumnail" />'?> </div> 
                                    <br>
                                        <div ><a href="product-details.php?reference=<?PHP echo $product['reference']; ?>">Quick View</a></div>
                                    
                                 
                                       <h4><?php echo $product['nom']; ?></h4>
                                       <p><?php echo$product['categorie']; ?></p>
                                       <div  ><?php echo number_format((float)$product['prix'],0, '.', ''). ' DT';?></div>
                                </figure>     
      ...
      for($i=1;$i<=$pagesTotales;$i++) {
         if($i == $pageCourante) {
            ...
            echo '<li><a href="shop-page.php?page='.$i.'">'.$i.'</a></li> ';
         }
      }
      ?>
      <li>
...
?>
                            <div class="shop-widget mt-50">
                                <h1 class="shop-sidebar-title"> Categories: </h1>
                                 <div class="shop-list-style mt-20">
                                    <ul>
                                       <li class="cat-item cat-item-63"><a href="shop-page.php">Tout</a> <span ></span></li>
            <?php
            foreach($cat as $row)
            {
        $cat_nom = $row['nomcat'];
        echo "<li class=\"cat-item cat-item-63\"><a href=\"shop-page.php?categorie=". $cat_nom ."\">". $cat_nom ."</a> <span ></span></li>";
            }
                            ...
                            <div class="footer-widget mb-30">
                                <div class="footer-info-wrapper">
                                    <div class="footer-logo">
                                        <a href="#">
                                            <img src="assets/img/logo/zanim.jpg" alt="">
                                        </a>
                                    </div>
...
<!-- Mirrored from demo.devitems.com/marten-v1/shop-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Feb 2019 21:56:49 GMT -->
</html>
