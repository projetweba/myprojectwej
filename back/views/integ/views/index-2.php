...
<!-- Mirrored from demo.devitems.com/marten-v1/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Feb 2019 21:58:35 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Zanimo - Pet  eCommerce B</title>
                            ...
                            <div class="main-menu text-center">
                                <nav>
                                    <ul>
                                     ...
                                     <li><a href="blog-leftsidebar.html"><a href="shop-page"> Products</a>
                                         <ul class="submenu">
                                                <li>
                                                  <a href="shop-page.php">Products Page </a>
                                                </li>
                                              
                                                <li>
                                                   <a href="shop-page.php">Products details</a>
                                                </li>
                                            </ul>
                                        </li>
                    ...
                    <div class="container">
                        <div class="slider-content slider-content-white slider-animated-2 text-center">
                            ...
                            <div class="slider-btn">
                                <a class="animated" href="shop-page.php">SHOP NOW</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="deal-content">
                            ...
                            <div class="deal-pro-price">
                                <span class="deal-old-price">120.000 DT </span>
                                <span> 90.000 DT </span>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-wrapper mb-30 gray-bg">
                            ...
                            <div class="blog-content">
                                ...
                                <h4><a href="blog-details.html">1.Trupanion Blog | Pet Insurance Blog</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-wrapper mb-30 gray-bg">
                            ...
                            <div class="blog-content">
                                ...
                                <h4><a href="blog-details.html">2. DogTipper | Pet Product Blog</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-wrapper mb-30 gray-bg">
                            ...
                            <div class="blog-content">
                                ...
                                <h4><a href="blog-details.html">Petsworld | Pet Supplies Blog</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="copyright text-center">
                                <p>Copyright © <a href="#">Z'animo.</a> All Right Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from demo.devitems.com/marten-v1/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Feb 2019 22:00:00 GMT -->
</html>
