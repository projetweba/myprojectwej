...
<!-- Mirrored from preview.uideck.com/items/inspire-pro/light/alert.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 03 Mar 2019 11:35:37 GMT -->
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
<title>Zanimo-Admin Template</title>
...
<ul class="dropdown-menu sub-down">
<li class="active">
<a href="alert.html">Produits et Categories</a>
</li>
<li>
...
<h4 class="page-title"> Affichage des Produit et catégorie</h4>
</div>
<div class="col-12 col-lg-9 col-md-6">
<ol class="breadcrumb float-right">
<li><a href="form-elements.php">Ajouter produit</a></li>
<li class="active"> / categorie</li>
</ol>
<?php echo '<a href="javascript:window.print()" class="btn btn-common mr-3">IMPRIMER </a>'; ?>
  <td><a href="integ/views/index-2.php" class="btn btn-common mr-3">Accéder au Front</a></td>
</div>
 </div>
...
<table  class="table table-hover table-lg">
  <thead>
<tr>
<td class="text-dark text-semibold">reference</td>
<td class="text-dark text-semibold">nom categorie</td>
...
foreach($listecategories as $row){
  ...
  <td><a href="modifcat.php?referencee=<?PHP echo $row['referencee'];?>">Modifier</a></td>
  </tr>
  <?PHP
}
?>
...
<div class="footer">
<div class="copyright">
<span>Copyright © 2018 <b class="text-dark">Zanimo</b>. All Right Reserved</span>
<span class="go-right">
