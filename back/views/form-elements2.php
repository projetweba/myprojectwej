...
<ul class="dropdown-menu sub-down">
<li>
<a href="alert.php">Produit Et Categories</a>
</li>
<li>
...
if (isset($_GET['reference'])){
    ...
    $result=$employeC->recupererEmploye($_GET['reference']);
...
if (isset($_POST['modifier'])){
	$employe=new employe($_POST['reference'],$_POST['nom'],$_POST['categorie'],$_POST['prix'],$_POST['description']);
	$employeC->modifierEmploye($employe,$_POST['desc_ini']);
	echo $_POST['desc_ini'];
...
<input type="text"  class="form-control" id="exampleInputName1" name="reference"  value="<?PHP echo $reference ?>">
</div>
<div class="form-group">
<label for="exampleInputEmail3">nom </label>
<input type="text" class="form-control" id="exampleInputEmail3" name="nom" value="<?PHP echo $nom ?>">
</div>

<div class="form-group">
<label for="exampleSelectGender">Categorie</label>
<select class="form-control" id="exampleSelectGender"  name="categorie" value="<?PHP echo $categorie ?>" >
...
<input type="text" class="form-control" id="exampleInputCity1"  name="prix" value="<?PHP echo $prix ?>">
</div>
<div class="form-group m-b-20">
<label for="exampleTextarea1">Description</label>
<input class="form-control" id="exampleTextarea1" name="description"  rows="2" value="<?PHP echo $description?>" >
</div>
