...
if (isset($_GET['referencee'])){
    ...
    $result=$categorieC->recuperercategorie($_GET['referencee']);
...
if (isset($_POST['modif'])){
	$categorie=new categorie($_POST['referencee'],$_POST['nomcat']);
	$categorieC->modifiercategorie($categorie,$_POST['nom_ini']);
	echo $_POST['nom_ini'];
...
<input type="text"  class="form-control" " name="referencee"  value="<?PHP echo $referencee?>">
</div>
<div class="form-group">
<label for="exampleInputEmail3">nom du categorie </label>
<input type="text" class="form-control"  name="nomcat" value="<?PHP echo $nomcat?>">
</div>
...
<input  type="hidden" name="nom_ini" value="<?PHP echo $_GET['referencee'];?>">
</div>
</form>
</div>
</div>
