...
<h4 class="card-title">Here are the details of the DeliveryMan you are searching for:</h4>
</div>
...
{
 $_GET["terme"] = htmlspecialchars($_GET["terme"]); //pour sécuriser le formulaire contre les intrusions html càd convertit les caractères spéciaux en entités HTML
 $terme = $_GET['terme'];
 ...
 if (isset($terme))
 {
  ...
  $select_terme = $bdd->prepare("SELECT nom_liv, tel_liv ,adresse_liv ,mail_liv FROM livreur WHERE nom_liv LIKE ? ");
...
<div class="element" id="columns" >
 <figure>
   <div class="text-muted"><?php echo "ID DeliveryMan: " ?><?php echo $terme_trouve['nom_liv']; ?></div></br>
   <div class="text-muted"><?php echo "Phone DeliveryMan: " ?><?php echo $terme_trouve ['tel_liv']; ?></div></br>
   <div class="text-muted"><?php echo "Adress DeliveryMan: " ?><?php echo $terme_trouve['adresse_liv']; ?></div></br>
   <div class="text-muted"><?php echo "Mail DeliveryMan: " ?><?php echo $terme_trouve['mail_liv']; ?></div></br>
 </figure>     
</div>
<?php  
  }
